    ...
    <AnimatePresence>
      {show && mode === "interior" && (
        <motion.div
          ...
          exit={{ opacity: 0 }}
          className="pointer-events-none fixed bottom-20 left-1/2 z-30 w-max max-w-[94vw] -translate-x-1/2"
        >
          <div className="glass-panel flex flex-wrap items-center justify-center gap-x-4 gap-y-1 rounded-lg px-5 py-3 font-mono text-xs text-alu-200">
