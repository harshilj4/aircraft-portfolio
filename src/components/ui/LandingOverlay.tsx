  ...
  return (
    <AnimatePresence>
      {mode === "landing" && (
        ...
        >
          <h1 className="text-3xl font-bold tracking-[0.18em] text-white sm:text-5xl">
            {personal.name.toUpperCase()}
          </h1>
          <p className="mt-2 px-5 font-mono text-[0.65rem] uppercase tracking-[0.3em] text-sky-accent sm:text-sm">
            {personal.headlineTiny} · Aerospace-Focused Designer & Builder
          </p>
          <p className="mt-3 max-w-xl px-6 text-sm text-alu-300">
          ...
          <p className="mt-4 font-mono text-[0.65rem] uppercase tracking-[0.25em] text-alu-500">
